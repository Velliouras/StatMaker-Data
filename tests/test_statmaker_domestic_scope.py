...
class StatMakerDomesticScopeTest(unittest.TestCase):
    ...
    def test_odds_universe_contains_exactly_fifty_three_leagues(self):
        self.assertEqual(53, len(scope.odds_universe_codes()))
    ...
    def test_odds_registry_filter_keeps_restored_leagues(self):
        payload = {
            "leagueCount": 4,
            "leagues": [
                {"leagueCode": "E0"},
