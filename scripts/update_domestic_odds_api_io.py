...
def decode_http_body(raw: bytes, headers: Any) -> str:
    ...
    The provider may return gzip/deflate content even when urllib does not
    transparently decompress it. Fail closed on unsupported encodings rather
    than feeding compressed bytes to UTF-8 decoding.
    """
